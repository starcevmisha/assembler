...
MIDI_CONTROL_PORT = 0331h
MIDI_DATA_PORT = 0330h
MIDI_UART_MODE = 3Fh ; set midi mode status command
MIDI_PIANO_INSTRUMENT = 7fh
...
.check_octave_code:
    ...
    jmp .error;               none of the keys pressed were valid keys
